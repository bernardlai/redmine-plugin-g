...
public abstract class AbstractAuthDao {
     ...
     */
    //Gionee laihh start
    public abstract RedmineUserData getRedmineUserData(String loginTable, String userField, String passField, String saltField, String username,String apiToken) throws RedmineAuthenticationException;
    //Gionee laihh end
}
